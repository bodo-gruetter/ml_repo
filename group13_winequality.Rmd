...
The dataset "winequalityN.csv" contains content information of different red and white wines in 12 columns. In the following, the individual attributes will be explained.
...
### Loading the data
In a first step the dataset is loaded and stored in R:
```{r}
