...
Only the variables "hr", "yr" and "season" are used to construct the tree. There are only 11 nodes
...
The graphic representation shows us what the MSE has already shown us. The deviation from the estimate (straight line) and thus the variance is large.
...
The MSE is very high at 66442. About thirty times as high as in the example of bagging (see Bagging).
